...
def CrossValidation(trainingdata, Kfold): 
    ...
    return n_neighbors,topbestmodels,X_train, X_test, y_train, y_test
def CalculatePerformanceMetric(SelectedNeighbors,topbestmodels,X_train, X_test, y_train, y_test):
    ...
    return
#============================PlotRoc_AucCurve=========================================
def PlotRoc_AucCurve(SelectedNeighbors,topbestmodels,X_train, X_test, y_train, y_test):
    ...
    return topbestmodels
    
def PlotPrecisionRecallCurve(SelectedNeighbors,topbestmodels,X_train, X_test, y_train, y_test):
...
Kfold =5
n_neighbors,topbestmodels,X_train, X_test, y_train, y_test = CrossValidation(trainingdata,Kfold )
...
topbestmodels = PlotRoc_AucCurve(n_neighbors,topbestmodels,X_train, X_test, y_train, y_test)
print("Generating the PR Curve For top 3 best models")
PlotPrecisionRecallCurve(n_neighbors,topbestmodels,X_train, X_test, y_train, y_test)
